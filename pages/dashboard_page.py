...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.activities_tittle = page.get_by_test_id("activities-widget-title-text")
    ...
    def check_visible_activities_chart(self):
        expect(self.activities_tittle).to_be_visible()
        expect(self.activities_tittle).to_have_text("Activities")
