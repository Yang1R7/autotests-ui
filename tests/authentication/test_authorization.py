...
class TestAuthentication:
    def test_successful_authorization(
        ...
        registration_page.register_form.fill(email="username@gmail.com", password="password", username="username")
    ...
    def test_navigate_from_authorization_to_registration(
        ...
        registration_page.register_form.check_visible(email="", username="", password="")
