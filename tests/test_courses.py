...
def test_empty_courses_list():
    with sync_playwright() as playwright:
        ...
        context.storage_state(path="browser-state-register-user.json")

    with sync_playwright() as playwright:
        browser = playwright.chromium.launch(headless=False)
        context = browser.new_context(storage_state="browser-state-register-user.json")
        page = context.new_page()
        ...
        empty_results_message = page.get_by_test_id("courses-list-empty-view-title-text")
        ...
        empty_state_description_text = page.get_by_test_id("courses-list-empty-view-description-text")
